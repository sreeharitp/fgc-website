...
const TimelineMobile2 = ({ timeline }) => {
  ...
  return (
    <div className="text-center   relative overflow-hidden " ref={ref}>
      {timeline.map((items) => (
        ...
        >
          <div className="h-[700px] w-[3px] bg-[#ddd] relative flex items-center  justify-center">
            <motion.span
              style={{
          ...
          <div className="w-[250px] text-right relative z-20">
            <Image
              src={items.img}
              height={250}
              width={250}
...
export default TimelineMobile2;
