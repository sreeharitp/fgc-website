...
import slide1 from "public/slider2.png";
        ...
        <SwiperSlide>
          <div className="w-full h-[60vh] md:h-[50vh] lg:h-[65vh] 3xl:h-[65vh] relative flex items-center justify-center">
            ...
            <div className="absolute z-10 w-full padding-x flex flex-col gap-6 3xl:gap-10 box-width bottom-8 sm:bottom-auto">
              ...
              >
                نحن ندير تكنولوجيا <br className="hidden sm:block" />
                المعلومات الخاصة بك،
                <br className="hidden sm:block" /> حتى تتمكن من إدارة عملك.
              </h1>
              <p className="text-white text-[20px] 3xl:text-[24px]" data-swiper-parallax="-1000">
                تولى مسؤولية استمرارية أعمالك من خلال حلول تكنولوجيا المعلومات
                المبتكرة
              </p>
              <div data-swiper-parallax="-1200" className="">
                <Button text="احصل على استشارة" url="" className="" />
              </div>
            </div>
          </div>
        </SwiperSlide>
